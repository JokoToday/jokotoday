...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  async function loadData() {
    try {
      const heroUrl = await getImageUrl('hero_image_url', defaultHeroImage);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((category) => {
              ...
              const categoryDesc = language === 'zh' ? (category.description_zh || category.description_en) : (language === 'th' ? category.description_th : category.description_en);
