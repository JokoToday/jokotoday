    ...
    <footer className="bg-primary-900 text-primary-50 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-primary-100">
              ...
              <div className="flex flex-col gap-1.5 mt-3">
                <a href="tel:0998929264" className="inline-flex items-center gap-2 text-primary-200 hover:text-primary-50 transition-colors">
                  <Phone className="w-3.5 h-3.5 flex-shrink-0" />
                  <span>099-892 9264</span>
                </a>
                <a href="tel:0659196689" className="inline-flex items-center gap-2 text-primary-200 hover:text-primary-50 transition-colors">
                  <Phone className="w-3.5 h-3.5 flex-shrink-0" />
                  <span>065-919 6689</span>
                </a>
              </div>
              <p className="text-xs mt-3 text-primary-200">
        ...
        <div className="mt-8 pt-8 border-t border-primary-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-200">
              ...
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 text-primary-300 hover:text-primary-50 hover:bg-primary-800 rounded-full transition-all duration-200 hover:-translate-y-0.5"
