            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm transition-colors focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          ...
          <div className="border-b border-gray-200 pb-4">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-gray-500 mb-2">
                Upload a QR code that links to this product. When scanned in-store, customers go directly to this product page.
              </p>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-xs px-3 py-1.5 bg-white border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition-colors disabled:opacity-50"
                      >
                        Replace
                      </button>
                      <button
                        ...
                        className="text-xs px-3 py-1.5 bg-white border border-red-300 text-red-600 rounded hover:bg-red-50 transition-colors flex items-center gap-1"
                      >
              ...
              />
              {errors.qr_code && (
                <p className="text-red-600 text-xs mt-1">{errors.qr_code}</p>
              )}
            </div>
          </div>
